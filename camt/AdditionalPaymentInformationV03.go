...
type AdditionalPaymentInformationV03 struct {
	...
	Information *model.PaymentComplementaryInformation2 `xml:"Inf"`
}

func (a *AdditionalPaymentInformationV03) AddAssignment() *model.CaseAssignment2 {
	a.Assignment = new(model.CaseAssignment2)
	return a.Assignment
}

func (a *AdditionalPaymentInformationV03) AddCase() *model.Case2 {
	a.Case = new(model.Case2)
	return a.Case
}

func (a *AdditionalPaymentInformationV03) AddUnderlying() *model.UnderlyingTransaction1Choice {
	a.Underlying = new(model.UnderlyingTransaction1Choice)
	return a.Underlying
}

func (a *AdditionalPaymentInformationV03) AddInformation() *model.PaymentComplementaryInformation2 {
	a.Information = new(model.PaymentComplementaryInformation2)
