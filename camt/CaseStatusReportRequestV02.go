...
type CaseStatusReportRequestV02 struct {
	...
	RequestHeader *model.ReportHeader2 `xml:"ReqHdr"`

	// Identifies the investigation case.
	Case *model.Case2 `xml:"Case"`
}

func (c *CaseStatusReportRequestV02) AddRequestHeader() *model.ReportHeader2 {
	c.RequestHeader = new(model.ReportHeader2)
	return c.RequestHeader
}

func (c *CaseStatusReportRequestV02) AddCase() *model.Case2 {
