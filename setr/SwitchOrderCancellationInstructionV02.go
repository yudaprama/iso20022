...
type SwitchOrderCancellationInstructionV02 struct {
	...
	OrderToBeCancelled *model.SwitchOrderInstruction1 `xml:"OrdrToBeCanc,omitempty"`
}

func (s *SwitchOrderCancellationInstructionV02) AddMasterReference() *model.AdditionalReference3 {
	s.MasterReference = new(model.AdditionalReference3)
	return s.MasterReference
}

func (s *SwitchOrderCancellationInstructionV02) AddPoolReference() *model.AdditionalReference3 {
	s.PoolReference = new(model.AdditionalReference3)
	return s.PoolReference
}

func (s *SwitchOrderCancellationInstructionV02) AddPreviousReference() *model.AdditionalReference3 {
	s.PreviousReference = new(model.AdditionalReference3)
	return s.PreviousReference
}

func (s *SwitchOrderCancellationInstructionV02) AddOrderToBeCancelled() *model.SwitchOrderInstruction1 {
	s.OrderToBeCancelled = new(model.SwitchOrderInstruction1)
