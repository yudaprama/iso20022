...
type SubscriptionBulkOrderCancellationRequestV03 struct {
	...
	CancellationByOrderDetails *model.SubscriptionBulkOrderInstruction2 `xml:"CxlByOrdrDtls,omitempty"`

	// Message is a copy.
	CopyDetails *model.CopyInformation2 `xml:"CpyDtls,omitempty"`
}

func (s *SubscriptionBulkOrderCancellationRequestV03) AddMessageIdentification() *model.MessageIdentification1 {
	s.MessageIdentification = new(model.MessageIdentification1)
	return s.MessageIdentification
}

func (s *SubscriptionBulkOrderCancellationRequestV03) AddPoolReference() *model.AdditionalReference3 {
	s.PoolReference = new(model.AdditionalReference3)
	return s.PoolReference
}

func (s *SubscriptionBulkOrderCancellationRequestV03) AddPreviousReference() *model.AdditionalReference3 {
	s.PreviousReference = new(model.AdditionalReference3)
	return s.PreviousReference
}

func (s *SubscriptionBulkOrderCancellationRequestV03) AddCancellationByReference() *model.InvestmentFundOrder1 {
	s.CancellationByReference = new(model.InvestmentFundOrder1)
	return s.CancellationByReference
}

func (s *SubscriptionBulkOrderCancellationRequestV03) AddCancellationByOrderDetails() *model.SubscriptionBulkOrderInstruction2 {
	s.CancellationByOrderDetails = new(model.SubscriptionBulkOrderInstruction2)
	return s.CancellationByOrderDetails
}

func (s *SubscriptionBulkOrderCancellationRequestV03) AddCopyDetails() *model.CopyInformation2 {
